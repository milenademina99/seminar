...
### Веб приложения,используюoие Markdown
1.Вики:
    1. DokuWiki (c помощью плагина)
    2. ikiwiki'
    3. Oddmuse
    4.PmWiki (С помощбю плагина )
2.Блоги:
...
3.CMS:
     ...
     -Typo3- с помощью плагина af_markdowmn
     -RadianCMS-один из видов разметки, доступный "из коробки"
 #### Табличные данные
 1|2|
 ---|:---:
 Разработчик|Джон Грувер
